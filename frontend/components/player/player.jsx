...
import {nextTrack, previousTrack, shuffle, repeat} from '../../actions/queue_actions';
            ...
            <div className="player">
                ...
                <div className="center">
                        <div className="controls">
                            <svg role="img" id="shuffle" height="16" width="16" viewBox="0 0 16 16" className="Svg-ulyrgf-0 hJgLcF" onClick={this.toggleShuffle}>
                            ...
                            <svg role="img" id="step-backward" height="16" width="16" viewBox="0 0 16 16" className="Svg-ulyrgf-0 hJgLcF" onClick={this.props.previousTrack}>
                            ...
                            <svg role="img" id="repeat" height="16" width="16" viewBox="0 0 16 16" className="Svg-ulyrgf-0 hJgLcF" onClick={this.toggleRepeat}>
